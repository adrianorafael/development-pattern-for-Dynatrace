...
A skill é um `SKILL.md`, **14 documentos de referência**, **18 templates** prontos para
...
Ela codifica **quatorze regras inegociáveis** e um **pipeline de oito fases** com três
...
4. [As quatorze regras](#as-quatorze-regras)
...
10. [Segurança proporcional ao porte](#segurança-proporcional-ao-porte)
11. [O que ela previne](#o-que-ela-previne)
12. [Comportamentos importantes](#comportamentos-importantes)
13. [Estrutura do repositório](#estrutura-do-repositório)
14. [Templates e ferramentas](#templates-e-ferramentas)
...
Esta é a parte que importa, e é o oposto do que "quatorze regras" costuma sugerir:
...
├── SKILL.md                          # 14 regras, 8 fases, 3 portões, roteamento
├── references/
