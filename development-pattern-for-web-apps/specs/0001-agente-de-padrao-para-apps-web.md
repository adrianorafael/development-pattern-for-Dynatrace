...
```
SKILL.md            14 regras · 8 fases · 3 portões · roteamento de referências
references/         14 documentos, um por área de risco
assets/templates/   18 arquivos copiáveis
assets/scripts/     2 scanners executáveis
docs/               página do projeto
```
...
| CT-009 | — | Contagens (14 regras, 14 referências, 18 templates) batem entre SKILL, README e página |
