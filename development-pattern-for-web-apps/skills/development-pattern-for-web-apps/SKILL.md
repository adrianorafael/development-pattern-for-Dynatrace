...
## R — As quatorze regras inegociáveis
...
3 BUILD       componentes, SQL parametrizado, segredos fora, wizard e updater no PHP
              → cada símbolo rastreado a uma fonte
